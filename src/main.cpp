...
void print_help() {
  std::cout << "SYNTH — always ready, always incomplete\n\n"
            << "Usage:\n"
            << "  synth <command> [arguments] [--json]\n"
            << "  synth ecosystem --watch --json\n\n"
            << "Read-only commands (without side effects):\n"
            << "  help\n"
            << "  version [--json]\n"
            << "  status [--json]\n"
            << "  foundation verify [--json]\n"
            << "  surfaces [--json]\n"
            << "  relations [--json]\n"
            << "  ecosystem [--json]\n"
            << "  resolve <surface> [--json]\n"
            << "  search <query> --source <source> [--json]\n"
            << "  info <identity> --source <source> [--json]\n"
            << "  installed [--json]\n\n"
            << "State-changing commands:\n"
            << "  evidence [--json]\n"
            << "  install <identity> --source <source> [--json]\n"
            << "  activate <identity> [--json]\n"
            << "  deactivate <identity> [--json]\n"
            << "  remove <identity> [--json]\n\n"
            << "Options:\n"
            << "  --json    Emit a machine-readable representation\n"
            << "  --watch   Stream ecosystem changes as NDJSON; requires --json\n"
            << "  --source  Local directory or file:// artifact source\n\n"
            << "Environment:\n"
            << "  XDG_CONFIG_HOME, XDG_DATA_HOME, XDG_STATE_HOME, XDG_RUNTIME_DIR\n"
            << "  SYNTH_DATA_DIR  Override the trusted documents and schemas root\n";
}
